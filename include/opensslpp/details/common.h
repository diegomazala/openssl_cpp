...
namespace opensslpp
{
    ...
    using DigestContextPtr = std::unique_ptr<EVP_MD_CTX, decltype(&EVP_MD_CTX_free)>;     // OpenSSL >= 1.1
    //using DigestContextPtr = std::unique_ptr<EVP_MD_CTX, decltype(&EVP_MD_CTX_destroy)>;    // OpenSSL <= 1.0
